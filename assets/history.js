window.HISTORY_DATA = [
  ...
  {
    "title": "Electrical Locomotive Maintainer (Qualified Electrician)",
    "start": 2017,
    "end": 2021,
    "summary": "Performed troubleshooting, maintenance, and repair of electric locomotives in a heavy maintenance depot, with a focus on overhauls and end to end fault finding on safety critical systems.",
    "sections": [
      {
        "heading": "Overhauls / Heavy Maintenance",
        "bullets": [
          "Performed electrical work for overhaul inspections, coordinating with mechanical teams and contractors where required",
          "Replaced critical cooling system components and inspected high voltage equipment for defects, wear, and insulation issues",
          "Removed and replaced undercarriage components including the 3 phase traction motors powering wheelsets",
          "Troubleshot faults uncovered during overhaul work, restoring systems to serviceable condition",
          "Interpreted electrical schematics and fault logs to isolate issues and validate repairs"
        ]
      },
      {
        "heading": "Depot Maintenance & Fault Finding",
        "bullets": [
          "Diagnosed and repaired electrical faults across multiple locomotive classes in an operational heavy maintenance depot environment",
          "Documented work performed and fault findings for shift handover and ongoing job tracking",
          "Supported safe isolation, testing, and return to service activities for high energy electrical systems"
        ]
      },
      {
        "heading": "Relief: Electronics Technician (as needed)",
        "bullets": [
          "Cleaned, inspected, and replaced components on large legacy electronic circuit boards used in older electric locomotive classes",
          "Performed basic board level troubleshooting and functional checks to support fleet availability"
        ]
      },
      {
        "heading": "Relief: Locomotive Specialist (brief coverage)",
        "bullets": [
          "Analyzed fleet fault reports across several locomotive classes and triaged technical issues",
          "Supported maintainers with troubleshooting guidance and long running fault investigations"
        ]
      }
    ]
  },
  {
    ...
    "start": 2013,
    "end": 2017,
    "summary": "Completed a four year electrical apprenticeship in a locomotive maintenance depot, progressing from supervised inspections to independent fault finding with sign off from qualified supervisors.",
    "sections": [
      {
        "heading": "Apprenticeship (Rolling Stock Maintenance)",
        "bullets": [
          "Performed scheduled maintenance inspections under supervision across multiple locomotive classes",
